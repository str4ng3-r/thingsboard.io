...
Here's how the two editions align in terms of core features, security, extensibility, and support. See the full comparison table [here](/products/mqtt-broker/#comparison-features).
