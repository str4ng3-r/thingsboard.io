...
### Resources
- [Astro syntax vs JSX - comparison](/reference/astro-syntax/#differences-between-astro-and-jsx)

- [Astro `<style>` tag](/guides/styling/#styling-in-astro)

- [CSS variables in Astro](/guides/styling/#css-variables)
