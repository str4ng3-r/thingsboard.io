...
This message can also appear when a type is imported without specifying that it is a [type import](/guides/typescript/#type-imports).

**See Also:**
-  [Type Imports](/guides/typescript/#type-imports)
