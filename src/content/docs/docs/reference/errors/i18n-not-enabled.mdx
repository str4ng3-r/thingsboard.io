...
For more information on internationalization support in Astro, see our [Internationalization guide](/guides/internationalization/).

**See Also:**
-  [Internationalization](/guides/internationalization/)
-  [`i18n` Configuration Reference](/reference/configuration-reference/#i18n)
