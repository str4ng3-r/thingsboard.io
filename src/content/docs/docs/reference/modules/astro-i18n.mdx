...
- [`base`](/reference/configuration-reference/#base)
- [`trailingSlash`](/reference/configuration-reference/#trailingslash)
- [`build.format`](/reference/configuration-reference/#buildformat)
...
For features and usage examples, [see our i18n routing guide](/guides/internationalization/).
...
Use this like [`getAbsoluteLocaleUrl`](/guides/internationalization/#custom-locale-paths) to return a list of absolute paths for all the locales.
...
A function that returns the `path` associated to one or more `codes` when [custom locale paths](/guides/internationalization/#custom-locale-paths) are configured.
...
A function that allows you to use your [`i18n.fallback` configuration](/reference/configuration-reference/#i18nfallback) in your own middleware.
