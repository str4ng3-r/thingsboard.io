...
[Claude Code](https://docs.anthropic.com/docs/claude-code/overview) is an agentic coding tool that runs on the command line. Enabling the Astro Docs MCP server allows it to access the latest documentation while generating Astro code.
...
[More info on using MCP servers with Claude Code](https://docs.anthropic.com/docs/claude-code/mcp)
...
[More info on using MCP servers with Claude.ai](https://support.anthropic.com/articles/10168395-setting-up-integrations-on-claude-ai#h_cda40ecb32)
...
[GitHub Copilot](https://docs.github.com/copilot/concepts/agents/coding-agent/about-coding-agent) can be used as a coding agent powered by GitHub Actions. Enabling the Astro Docs MCP server allows it to access the latest Astro documentation when answering questions or performing coding tasks.
...
Learn more about [extending GitHub Copilot coding agent with MCP servers](https://docs.github.com/copilot/how-tos/use-copilot-agents/coding-agent/extend-coding-agent-with-mcp).
