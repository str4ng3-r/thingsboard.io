...
1. **An Astro project** - If you don't have an Astro project yet, our [Installation guide](/install-and-setup/) will get you up and running in no time.
...
```
:::tip
Read more about [using environment variables](/guides/environment-variables/) and `.env` files in Astro.
:::
...
1. A Ghost blog 
2. An Astro project integrated with the [Ghost content API](https://www.npmjs.com/package/@tryghost/content-api) - See [integrating with Astro](/guides/cms/ghost/#integrating-with-astro) for more details on how to set up an Astro project with Ghost.
...
The page `src/pages/post/[slug].astro` [dynamically generates a page](/guides/routing/#dynamic-routes) for each post.
...
```
:::note
`<Fragment />` is a built-in Astro component which allows you to avoid an unnecessary wrapper element. This can be especially useful when fetching HTML from a CMS (e.g. Ghost or [WordPress](/guides/cms/wordpress/)).
:::

### Publishing your site
To deploy your site visit our [deployment guide](/guides/deploy/) and follow the instructions for your preferred hosting provider.
...
If you found (or made!) a helpful video or blog post about using Ghost with Astro, [add it to this list](https://github.com/withastro/docs/edit/main/src/content/docs/guides/cms/ghost.mdx)!
:::
