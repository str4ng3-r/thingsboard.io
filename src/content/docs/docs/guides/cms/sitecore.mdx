...
<Steps>
1. [Create a Sitecore Headless website](https://doc.sitecore.com/xp/developers/sxa/103/sitecore-experience-accelerator/create-a-headless-tenant-and-site.html) following Sitecore's official documentation.
