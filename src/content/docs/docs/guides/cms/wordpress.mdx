...
The page `src/pages/dinos/[slug].astro` [dynamically generates a page](/guides/routing/#dynamic-routes) for each dinosaur.
...
If you found (or made!) a helpful video or blog post about using headless WordPress with Astro, [add it to this list](https://github.com/withastro/docs/edit/main/src/content/docs/guides/cms/wordpress.mdx)!
:::
