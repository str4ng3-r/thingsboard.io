...
1. **An on-demand rendered Astro project** with the [Node.js adapter](/guides/integrations-guide/node/) installed and `output: 'server'` configured - If you don't have an Astro project yet, our [installation guide](/install-and-setup/) will get you up and running in no time.
...
For Astro, visit our [deployment guides](/guides/deploy/) and follow the instructions for your preferred hosting provider.
