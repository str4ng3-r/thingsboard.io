...
See our separate guide for [adding Firebase backend services](/guides/backend/firebase/) such as databases, authentication, and storage.
...
To enable SSR in your Astro project and deploy on Firebase add the [Node.js adapter](/guides/integrations-guide/node/). 
