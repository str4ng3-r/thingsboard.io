...
- [Azion CLI](https://www.azion.com/documentation/products/azion-cli/overview/) installed for faster project setup and deployment.
...
1. **Install the Azion CLI:**  
   ...
   - Download and install the [Azion CLI](https://www.azion.com/documentation/products/azion-cli/overview/) for easier management and deployment.
...
If you are directly importing a Node.js runtime API, please refer to the [Azion Node.js compatibility](https://www.azion.com/documentation/products/azion-edge-runtime/compatibility/node/) for further steps on how to resolve this.
