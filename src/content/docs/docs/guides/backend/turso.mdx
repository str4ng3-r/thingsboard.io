...
:::caution
Do not use the `PUBLIC_` prefix when creating these private [environment variables](/guides/environment-variables/). This will expose these values on the client.
:::
