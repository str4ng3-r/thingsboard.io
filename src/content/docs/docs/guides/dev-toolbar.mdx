...
This toolbar includes a number of useful tools for debugging and inspecting your site during development and can be [extended with more dev toolbar apps](#extending-the-dev-toolbar) found in the integrations directory. You can even [build your own toolbar apps](/recipes/making-toolbar-apps/) using the [Dev Toolbar API](/reference/dev-toolbar-app-reference/)!
...
<RecipeLinks slugs={["recipes/making-toolbar-apps"]} />
