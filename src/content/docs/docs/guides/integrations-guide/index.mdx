...
- Unlock React, Vue, Svelte, Solid, and other popular UI frameworks with a [renderer](/guides/framework-components/).
- Enable on-demand rendering with an [SSR adapter](/guides/on-demand-rendering/).
...
If you see any warnings like `Cannot find package '[package-name]'` after adding an integration, your package manager may not have installed [peer dependencies](https://nodejs.org/blog/npm/peer-dependencies/) for you. To install these missing packages, run the following command:
...
Check out the [Integration API](/reference/integrations-reference/) reference to learn all of the different ways that you can write an integration.
...
Check out the [Integration API](/reference/integrations-reference/) reference to learn what integrations can do and how to write one yourself.
