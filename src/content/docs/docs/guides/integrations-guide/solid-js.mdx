...
Use a SolidJS component as you would any [UI framework component](/guides/framework-components/).
...
[astro-client-only]: /reference/directives-reference/#clientonly
