...
If this option isn't set, `debug` mode will be on by default in [dev](/reference/cli-reference/#astro-dev) or [preview](/reference/cli-reference/#astro-preview) mode.
