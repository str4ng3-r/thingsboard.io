...
:::caution[Removed]
`@astrojs/prefetch` has been replaced by the [built-in `prefetch` feature](/guides/prefetch/) introduced in Astro 3.5. See the [migration guide](/guides/prefetch/#migrating-from-astrojsprefetch) for instructions on updating an older project.
