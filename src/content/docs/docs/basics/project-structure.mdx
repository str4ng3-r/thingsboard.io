...
- [Pages](/basics/astro-pages/)
- [Layouts](/basics/layouts/)
- [Astro components](/basics/astro-components/)
- [UI framework components (React, etc.)](/guides/framework-components/)
- [Styles (CSS, Sass)](/guides/styling/)
- [Markdown](/guides/markdown-content/)
- [Images to be optimized and processed by Astro](/guides/images/)
...
Pages routes are created for your site by adding [supported file types](/basics/astro-pages/#supported-page-files) to this directory.
...
**Components** are reusable units of code for your HTML pages. These could be [Astro components](/basics/astro-components/), or [UI framework components](/guides/framework-components/) like React or Vue.  It is common to group and organize all of your project components together in this folder.

This is a common convention in Astro projects, but it is not required. Feel free to organize your components however you like!

### `src/layouts`

[Layouts](/basics/layouts/) are Astro components that define the UI structure shared by one or more [pages](/basics/astro-pages/).
...
See the [configuration reference](/reference/configuration-reference/) for complete details.
...
See the [TypeScript Guide](/guides/typescript/) for details on setting configurations.
