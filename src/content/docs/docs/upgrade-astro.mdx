...
- [Upgrade to v5](/guides/upgrade-to/v5/)
- [Upgrade to v4](/guides/upgrade-to/v4/)
- [Upgrade to v3](/guides/upgrade-to/v3/)
- [Upgrade to v2](/guides/upgrade-to/v2/)
- [Upgrade to v1](/guides/upgrade-to/v1/)
...
- [unmaintained v4.16.17 snapshot](https://v4.docs.astro.build/getting-started/)
- [unmaintained v3.6.3 snapshot](https://web.archive.org/web/20231203051122/https://docs.astro.build/getting-started/)
- [unmaintained v2.10.15 snapshot](https://web.archive.org/web/20230822134745/https://docs.astro.build/getting-started)
...
- Astro supports the [**latest _Maintenance_ LTS** version of Node.js](https://nodejs.org/about/previous-releases#release-schedule).
- Astro supports the [**current _Active_ LTS** version of Node.js](https://nodejs.org/about/previous-releases#release-schedule)
